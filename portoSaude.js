...
respostaC:"Além dos dependentes tradicionais, o Porto Saúde permite a inclusão de animais de estimação como dependentes.",
...
respostaC:"A coparticipação é o valor pago por quem contrata o seguro seja pessoa física ou jurídica, para um grupo de pessoas e/ou pelo segurado.", /*respota correta*/
...
respostaC:"A Porto Saúde e Odontológico oferecem o reembolso em forma de passagens aéreas para destinos paradisíacos.", 
respostaD:"Os planos da Porto Saúde e Odontológico oferecem um reembolso em forma de obras de arte." 
},
...
respostaC:"Em vez de enfatizar a adoção de hábitos saudáveis, os programas de promoção da saúde são uma espécie de dia livre para os participantes.", 
respostaD:"Os Programas de Promoção da Saúde consistem em uma série de desafios divertidos." 
},
...
respostaC:"CIPA é uma comissão de entretenimento da empresa, responsável por organizar festas, eventos e atividades recreativas para os funcionários.",
respostaD:"CIPA é uma comissão de interpretação artística, encarregada de encenar peças teatrais sobre prevenção de acidentes no trabalho."
},
...
respostaC:"O Seguro Odontológico é reservado apenas para pessoas que tenham sorrido para a Lua cheia pelo menos uma vez em suas vidas.", 
respostaD:"O seguro pode ser contratado por empresas a partir de 03 vidas em todo o território nacional." /*respota correta*/
},
...
respostaC:"Sim. Você encontra a lista de dentistas disponíveis, acessando a página de Rede Referenciada Odonto.",  /*respota correta*/
respostaD:"No Seguro Odontológico, o tratamento de canal é coberto somente para dentes que precisam de um tratamento musical." 
},
...
respostaD:"O seguro odontológico possui uma vigência determinada por enigmas matemáticos." 
},
...
respostaC:"Você pode consultar o número da carteirinha do seu plano Seguro Saúde e/ou Plano Odontológico por meio do aplicativo ou da Área do Cliente.", /*respota correta*/
respostaD:"O número da carteirinha é guardado por uma árvore sábia em uma floresta encantada."
},
...
respostaC:"O segurado pode escolher um dentista fora da Rede Referenciada, mas somente se ele trouxer um buquê de flores encantadas para o dentista.", 
